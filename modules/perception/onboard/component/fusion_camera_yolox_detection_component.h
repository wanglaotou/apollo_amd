...
#include "modules/perception/inference/yolox/vision_yolox_detect.h"
...
class FusionCameraYoloxDetectionComponent : public apollo::cyber::Component<> {
 public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW

 public:
  FusionCameraYoloxDetectionComponent() : seq_num_(0) {}
  ~FusionCameraYoloxDetectionComponent();

  FusionCameraYoloxDetectionComponent(const FusionCameraYoloxDetectionComponent&) =
      delete;
  FusionCameraYoloxDetectionComponent& operator=(
      const FusionCameraYoloxDetectionComponent&) = delete;
 ...
 private:
  ...
  int MakeCameraDebugMsg(
    ...
    //   const camera::CameraFrameYolox& camera_yolox_frame,
...
//   EigenVector<camera::CameraFrameYolox> camera_yolox_frames_;
...
CYBER_REGISTER_COMPONENT(FusionCameraYoloxDetectionComponent);
