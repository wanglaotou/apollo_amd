...
public:
    ...
    //!
    //! Sets the Model trtDataType, one of the following: float -d 32 (default), half precision -d 16, and int8 -d 8 data types.
    //!
    //! \see getModelDtype()
    //!
    virtual void setModelDtype(const nvinfer1::trtDataType) TRTNOEXCEPT = 0;
    ...
    //!
    virtual nvinfer1::trtDataType getModelDtype() const TRTNOEXCEPT = 0;
