...
{
public:
    trtDataType type;      //!< The type of the weights.
...
public:
    ...
    virtual trtDataType type() const noexcept = 0;    //!< The type of the memory that was allocated.
...
protected:
    ...
    //!
    TRT_DEPRECATED
    bool supportsFormat(trtDataType /*type*/, PluginFormat /*format*/) const _TENSORRT_FINAL TRTNOEXCEPT { return false; }
...
public:
    ...
    //! \see getBindingIndex()
    //!
    virtual trtDataType getBindingtrtDataType(int bindingIndex) const noexcept = 0;
...
extern "C" void* createInferRuntime_INTERNAL(void* logger, int version);
...
extern "C" void* createInferRefitter_INTERNAL(void* engine, void* logger, int version);
