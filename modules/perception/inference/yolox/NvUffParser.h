...
public:
    ...
    virtual bool parse(const char* file,
                       ...
                       nvinfer1::trtDataType weightsType=nvinfer1::trtDataType::kFLOAT) TRTNOEXCEPT = 0;
...
IUffParser* createUffParser() TRTNOEXCEPT;
...
void shutdownProtobufLibrary(void) TRTNOEXCEPT;
...
extern "C" void* createNvUffParser_INTERNAL() TRTNOEXCEPT;
