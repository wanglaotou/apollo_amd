...
namespace utils
{
    ...
    //! \return True on success, false on failure.
    //!
    // TENSORRTAPI bool transposeSubBuffers(void *input, trtDataType type, int num, int height, int width);
    bool transposeSubBuffers(void *input, trtDataType type, int num, int height, int width);
