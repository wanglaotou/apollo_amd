...
public:
     ...
     */
    virtual bool supportsFormat(const nvinfer1::trtDataType type, nvinfer1::PluginFormat format) const override;

    virtual void configureWithFormat(const nvinfer1::Dims* inputDims, int nbInputs, const nvinfer1::Dims* outputDims,
                                     int nbOutputs, nvinfer1::trtDataType type, nvinfer1::PluginFormat format,
...
private:
    ...
    nvinfer1::trtDataType mtrtDataType{nvinfer1::trtDataType::kFLOAT};
